...
import Payment from '../../../components/payment/bobDinamic'
        ...
        value <= 0 ? 
          ...
          (
            <>
              ...
              <FixedPayment symbol={'Bs'} amount={value} money={'BOB'} />
              <Container>
                <Payment onSubmit={handleSubmit} error={error} value={value} />
              </Container>
              <FixedFooter country='BOB' />
            </>       
          )
      }
    </>
...
DinamicBob.getInitialProps = async ctx => { 

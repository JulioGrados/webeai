...
import { Article, Error404, Footer, HeadPage } from '../../../components'
import { Container } from '../../../styles/main'
import Payment from '../../../components/payment/ecuDinamic'
        ...
        value <= 0 ? 
          ...
          (
            <>
              ...
              <FixedPayment symbol={'$'} amount={value} money={'USD'} />
              <Container>
                <Payment onSubmit={handleSubmit} error={error} value={value} />
              </Container>
              <FixedFooter country='USD' />
            </>       
          )
      }
    </>
...
DinamicUsd.getInitialProps = async ctx => { 

...
import Payment from '../../../components/payment/copDinamic'
        ...
        value <= 0 ? 
          ...
          (
            <>
              ...
              <FixedPayment symbol={'$'} amount={value} money={'COP'} />
              <Container>
...
DinamicCop.getInitialProps = async ctx => { 

...
import Payment from '../../../components/payment/clpDinamic'
        ...
        value <= 0 ? 
          ...
          (
            <>
              ...
              <FixedPayment symbol={'$'} amount={value} money={'CLP'} />
              <Container>
...
DinamicClp.getInitialProps = async ctx => { 

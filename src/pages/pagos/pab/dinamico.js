...
import Payment from '../../../components/payment/pabDinamic'
        ...
        value <= 0 ? 
          ...
          (
            <>
              ...
              <FixedPayment symbol={'$'} amount={value} money={'PAB'} />
              <Container>
                <Payment onSubmit={handleSubmit} error={error} value={value} />
              </Container>
              <FixedFooter country='PAB' />
            </>       
          )
      }
    </>
...
DinamicBap.getInitialProps = async ctx => { 
